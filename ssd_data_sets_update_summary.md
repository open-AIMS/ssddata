...
| Value | Behaviour |
|----|----|
| `"geomean"` (default) | Applies geometric mean ([`gm_mean()`](https://open-aims.github.io/ssddata/reference/gm_mean.md)) to collapse duplicate Species rows; emits a [`message()`](https://rdrr.io/r/base/message.html) listing affected datasets |
