...
- [`ssddata`](https://open-aims.github.io/ssddata/dev/reference/ssddata-package.md)
  [`ssddata-package`](https://open-aims.github.io/ssddata/dev/reference/ssddata-package.md)
...
- [`aims_aluminium_marine`](https://open-aims.github.io/ssddata/dev/reference/aims_aluminium_marine.md)
  : Species Sensitivity Data for aluminium_marine
- [`aims_gallium_marine`](https://open-aims.github.io/ssddata/dev/reference/aims_gallium_marine.md)
  : Species Sensitivity Data for gallium_marine
- [`aims_molybdenum_marine`](https://open-aims.github.io/ssddata/dev/reference/aims_molybdenum_marine.md)
  : Species Sensitivity Data for molybdenum_marine

### Data provided from anonymous sources

- [`anon_a`](https://open-aims.github.io/ssddata/dev/reference/anon_a.md)
  : Anonymous Species Sensitivity Data anon_a
- [`anon_b`](https://open-aims.github.io/ssddata/dev/reference/anon_b.md)
  : Anonymous Species Sensitivity Data anon_b
- [`anon_c`](https://open-aims.github.io/ssddata/dev/reference/anon_c.md)
  : Anonymous Species Sensitivity Data anon_c
- [`anon_d`](https://open-aims.github.io/ssddata/dev/reference/anon_d.md)
  : Anonymous Species Sensitivity Data anon_d
- [`anon_e`](https://open-aims.github.io/ssddata/dev/reference/anon_e.md)
  : Anonymous Species Sensitivity Data anon_e

### Data from the Australian and New Zealand guidelines

- [`anzg_alpha_cypermethrin_fresh`](https://open-aims.github.io/ssddata/dev/reference/anzg_alpha_cypermethrin_fresh.md)
  : Species Sensitivity Data for alpha_cypermethrin_fresh
- [`anzg_aluminium_marine`](https://open-aims.github.io/ssddata/dev/reference/anzg_aluminium_marine.md)
  : Species Sensitivity Data for aluminium_marine
- [`anzg_ametryn_fresh`](https://open-aims.github.io/ssddata/dev/reference/anzg_ametryn_fresh.md)
  : Species Sensitivity Data for ametryn_fresh
- [`anzg_ammonia_fresh`](https://open-aims.github.io/ssddata/dev/reference/anzg_ammonia_fresh.md)
  : Species Sensitivity Data for ammonia_fresh
- [`anzg_bisphenol_a_fresh`](https://open-aims.github.io/ssddata/dev/reference/anzg_bisphenol_a_fresh.md)
  : Species Sensitivity Data for bisphenol_a_fresh
- [`anzg_bisphenol_a_marine`](https://open-aims.github.io/ssddata/dev/reference/anzg_bisphenol_a_marine.md)
...
- [`ccme_boron`](https://open-aims.github.io/ssddata/dev/reference/ccme_boron.md)
  : CCME Species Sensitivity Data for ccme_boron
- [`ccme_cadmium`](https://open-aims.github.io/ssddata/dev/reference/ccme_cadmium.md)
  : CCME Species Sensitivity Data for ccme_cadmium
- [`ccme_chloride`](https://open-aims.github.io/ssddata/dev/reference/ccme_chloride.md)
  : CCME Species Sensitivity Data for ccme_chloride
- [`ccme_endosulfan`](https://open-aims.github.io/ssddata/dev/reference/ccme_endosulfan.md)
  : CCME Species Sensitivity Data for ccme_endosulfan
- [`ccme_glyphosate`](https://open-aims.github.io/ssddata/dev/reference/ccme_glyphosate.md)
  : CCME Species Sensitivity Data for ccme_glyphosate
- [`ccme_silver`](https://open-aims.github.io/ssddata/dev/reference/ccme_silver.md)
  : CCME Species Sensitivity Data for ccme_silver
- [`ccme_uranium`](https://open-aims.github.io/ssddata/dev/reference/ccme_uranium.md)
...
- [`csiro_chlorine_marine`](https://open-aims.github.io/ssddata/dev/reference/csiro_chlorine_marine.md)
  : Species Sensitivity Data for chlorine_marine
- [`csiro_cobalt_marine`](https://open-aims.github.io/ssddata/dev/reference/csiro_cobalt_marine.md)
  : Species Sensitivity Data for cobalt_marine
- [`csiro_lead_marine`](https://open-aims.github.io/ssddata/dev/reference/csiro_lead_marine.md)
...
- [`aims_data`](https://open-aims.github.io/ssddata/dev/reference/aims_data.md)
  : Species Sensitivity Data provided by AIMS
- [`anon_data`](https://open-aims.github.io/ssddata/dev/reference/anon_data.md)
  : Anonymous Species Sensitivity Data
- [`anzg_data`](https://open-aims.github.io/ssddata/dev/reference/anzg_data.md)
  : ANZG Species Sensitivity Data
- [`ccme_data`](https://open-aims.github.io/ssddata/dev/reference/ccme_data.md)
...
- [`ssd_fits`](https://open-aims.github.io/ssddata/dev/reference/ssd_fits.md)
