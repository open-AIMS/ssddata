...
- acute:
  ...
  (EC50/LC50). See
  [envirotox_acute](https://open-aims.github.io/ssddata/reference/envirotox_acute.md)
...
- chronic:
  ...
  (NOEC/NOEL). See
  [envirotox_chronic](https://open-aims.github.io/ssddata/reference/envirotox_chronic.md)
  for full column descriptions.
...
- chemical:
  ...
  [envirotox_chemical](https://open-aims.github.io/ssddata/reference/envirotox_chemical.md)
  for full column descriptions.
