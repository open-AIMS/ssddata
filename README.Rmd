...
The package also includes wqbench_data, a large data set from the US EPA ECOTOX database, cleaned and standardized by the [`wqbench`](https://github.com/bcgov/wqbench/) package.
