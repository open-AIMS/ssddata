# endpoint_2016_to_2000_lookup_build
...
This iteration (v2) specifically refines mapping for previously unmapped or poorly mapped labels, including:
...
Residual unmapped labels can be reviewed using `endpoint_2016_to_2000_lookup_unmapped.csv`. Each row includes the raw label, its normalised form, the number of 2016 rows it affects, and `needs_review = TRUE`.
