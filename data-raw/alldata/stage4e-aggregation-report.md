...
Generated: 2026-06-26 16:51:31.185987
...
- Rows entering aggregation pipeline: 281994
...
**Hard-excluded rows (dropped):** 54 (low_hard: 48; high_hard: 6)
...
**Soft-flagged rows retained:** 3280 (low_soft: 540; high_soft: 2740)
...
- wqbench / high_soft: 2300
- wqbench / low_soft:  461

**Soft-only fallback groups (Step 1):** 1510
- Rows entering geomean step after plausibility filter: 281940
...
- Total groups formed: 132745
- Singleton groups (n = 1): 88587 (66.7%)
- Multi-record groups: 44158 (33.3%)
- Groups flagged (max/min > 10): 6357 (4.79%)
...
- Step 1 groups with NA life_stage: 81163
- Step 1 groups with NA duration_hours: 67
- `lifestage_mixed = TRUE` flags at Step 2: 4095
- `duration_mixed = TRUE` flags at Step 2: 18

## 7. Output summary

- Total rows in `uncurated_raw_aggregated.csv`: 59200
- Distinct chemicals (`casnumber_grouped`): 5672
...
- Rows with `any_acr_applied == TRUE`: 44059 (74.4%)
- Rows with `any_conc_flagged == TRUE`: 857 (1.45%)
- Rows with `geomean_flagged == TRUE`: 4070 (6.88%)
...
- `uncurated_raw_aggregated.csv`: 13.7 MB
