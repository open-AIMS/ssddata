...
#           data-raw/alldata/scripts/stage4b-extract.R line ~807), while anztox and
...
#           prompts/alldata/stage4c-dedup.md): data-raw/alldata/scripts/stage4c-effect-category-fixup.R
...
add_report(
  ...
  "`data-raw/alldata/scripts/stage4c-effect-category-fixup.R`, which harmonised ",
...
add_report(
  ...
  "anywhere in the file. `data-raw/alldata/scripts/stage4c-effect-category-fixup.R` has since ",
...
add_report(
  ...
  "cross-source vocabulary.** `data-raw/alldata/scripts/stage4c-effect-category-fixup.R` mapped ",
...
add_report(
  ...
  "codes. A first-pass keyword classifier (`data-raw/alldata/scripts/stage4c-effect-category-fixup.R` ",
...
add_report(
  ...
  "no change needed.** `data-raw/alldata/scripts/stage4c-effect-category-fixup.R` Step 1d ",
