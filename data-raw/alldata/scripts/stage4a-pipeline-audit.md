...
`data-raw/alldata/scripts/stage4a-pipeline-audit.md` with a specific section structure, and
...
`data-raw/alldata/scripts/stage3-media-audit.md` first. Then read all three `DATASET.R`
...
`data-raw/alldata/scripts/stage4a-pipeline-audit.md` following the requested section
...
are reproducible via `data-raw/alldata/scripts/stage4a-supplementary-db-audit.R` (read-only;
...
(`data-raw/alldata/scripts/stage4a-pipeline-audit.md`), and
...
`data-raw/alldata/scripts/stage4a-supplementary-db-audit.R`, using the identical connection
...
`data-raw/alldata/scripts/stage4a-supplementary-db-audit.R`, re-ran it end-to-end to
