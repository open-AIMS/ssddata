...
#' for \strong{\emph{bisphenol_a}} in marine water.
#' 
...
#'\insertRef{bisphenol-a-marine2023}{ssddata} 
#'
#' 
...
#' more information. }
#' 
#' @name anzg_bisphenol_a_marine
#' @docType data
#' @format An object of class \code{tbl_df} (inherits from \code{tbl},
#' \code{data.frame}) with 8 rows and 7 columns.
#' @keywords datasets
#' @examples
#' 
