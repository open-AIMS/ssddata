#' Species Sensitivity Data for nitrate_moderate_freshwater
#' 
...
#' for \strong{\emph{nitrate}} in moderate freshwater.
#' 
...
#' more information. }
#' 
#' @name anzg_nitrate_moderate_freshwater
#' @docType data
...
#' @examples
#' 
#' print(anzg_nitrate_moderate_freshwater, n=Inf)
#' 
NULL
