#' Species Sensitivity Data for nitrate_hard_freshwater
#' 
...
#' for \strong{\emph{nitrate}} in hard freshwater.
#' 
...
#'\insertRef{nitrate-fresh2024}{ssddata} 
#'
#' 
...
#' more information. }
#' 
#' @name anzg_nitrate_hard_freshwater
#' @docType data
#' @format An object of class \code{tbl_df} (inherits from \code{tbl},
#' \code{data.frame}) with 12 rows and 9 columns.
#' @keywords datasets
#' @examples
#' 
#' print(anzg_nitrate_hard_freshwater, n=Inf)
#' 
NULL
