...
#' in the analysis by \insertRef{Iwasaki2025}{ssddata}: more than 50 species
...
#'
#' @seealso [envirotox_data], [envirotox_chronic], [envirotox_chemical]
#'
#' @name envirotox_acute
#' @docType data
#' @format A tibble with 14,949 rows and 6 columns:
#' \describe{
...
#'   \item{Iwasaki25}{Whether the chemical was included in Iwasaki et al.
#'     (2025) (lgl).}
#' }
